...
R — 117 in total** — spanning degree and strength, distance and closeness,
...
records <- list(
  ...
  rec("Spectral, walk and influence",
      ...
      r"(`ncvote_theta`)",
      "A high score indicates an early election. With $\theta = 1$ and no two-hop weakening this is VoteRank.",
