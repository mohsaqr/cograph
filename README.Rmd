...
**Sonnet** is a modern R package for network visualization. It renders publication-ready network plots from adjacency matrices, edge lists, igraph, statnet network, qgraph, or tna objects using a pipe-friendly API with full control over nodes, edges, layouts, and themes.
...
Sonnet supports statistical edge visualization with CI underlays and significance notation.
