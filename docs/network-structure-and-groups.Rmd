...
When you call `as_cograph()`, it creates a lightweight `cograph_network` object. Use the getter functions below for stable access to nodes, edges, labels, counts, and directedness.
