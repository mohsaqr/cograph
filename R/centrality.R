...
#' data frame. Accepts matrices, igraph objects, sonnet_network, or tna objects.
#'
#' @param x Network input (matrix, igraph, network, sonnet_network, tna object)
...
to_igraph <- function(x, directed = NULL) {
  ...
  stop("x must be a matrix, igraph, network, sonnet_network, or tna object",
       call. = FALSE)
}
