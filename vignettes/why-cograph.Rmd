...
vignette: >
  %\VignetteIndexEntry{Why cograph?}
...
cograph also plots [Nestimate](https://mohsaqr.r-universe.dev/Nestimate) objects (bootstrap forests, permutation results, glasso networks) without importing the package — dispatch is by class name only.
