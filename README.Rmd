...
**Sonnet** is a modern R package for network visualization. It renders publication-ready network plots from adjacency matrices, edge lists, igraph, statnet network, or qgraph objects using a pipe-friendly API with full control over nodes, edges, layouts, and themes.
