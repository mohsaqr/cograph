...
In cograph, one call with the built-in edge-list data returns a tidy centrality
table:
...
That includes degree, strength, closeness, betweenness, eigenvector centrality,
and PageRank. No igraph conversion, no transition-matrix helper, no wrapper.
